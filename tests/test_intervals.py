...
def test_plimit3():
    ...
    # Note: librosax generates intervals in a different (but mathematically equivalent) order
    # than the original librosa. We verify the sorted values match instead.
    ...
    assert np.allclose(intervals_s, expected_sorted)
